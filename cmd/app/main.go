...
func main() {
	...
	pboidc.RegisterSecurityTokenServiceServer(d.Server, octosts.NewSecurityTokenServiceServer(
		im, ceclient, appConfig.Domain, baseCfg.Metrics,
		baseCfg.EnforceOrgPolicy, baseCfg.EnforceOrgPolicyWarn,
	))
